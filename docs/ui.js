...
var _user$project$Models$initModel = {allSongs: _krisajenkins$remotedata$RemoteData$Loading, mdl: _debois$elm_mdl$Material$model, layout: _user$project$Layout$model};
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {allSongs: a, mdl: b, layout: c};
	});
...
var _user$project$View$songRow = function (song) {
	return A2(
...
var _user$project$View$viewSongsByFoot = function (songsByFoot) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								A2(_elm_lang$core$List$map, _user$project$View$songRow, songsByFoot.songs)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$View$viewAllSongs = function (allSongs) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$View$viewSongsByFoot, allSongs.songsByfoot));
};
	...
	function (model, allSongs) {
		return A4(
			...
			},
			{
				...
				main: {
					ctor: '::',
					_0: _user$project$View$viewAllSongs(allSongs),
					_1: {ctor: '[]'}
				}
			});
	});
