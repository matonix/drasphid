...
var _user$project$Bpm$strToFloat = function (_p0) {
	return A2(
		_elm_lang$core$Result$withDefault,
		0,
		_elm_lang$core$String$toFloat(_p0));
};
var _user$project$Bpm$eqEither = F2(
	function (x, y) {
		return _elm_lang$core$Native_Utils.eq(
			_toastal$either$Either$isLeft(x),
			_toastal$either$Either$isLeft(y));
	});
var _user$project$Bpm$groupEither = function (xs_) {
	var _p1 = xs_;
	if (_p1.ctor === '[]') {
		return {ctor: '[]'};
	} else {
		...
		var _p2 = A2(
			_elm_community$list_extra$List_Extra$span,
			_user$project$Bpm$eqEither(_p4),
			_p1._1);
		var ys = _p2._0;
		var zs = _p2._1;
		var _p3 = _p4;
		if (_p3.ctor === 'Left') {
			return {
				ctor: '::',
				_0: _toastal$either$Either$Left(
					{
						ctor: '::',
						_0: _p3._0,
						_1: _toastal$either$Either$lefts(ys)
					}),
				_1: _user$project$Bpm$groupEither(zs)
			};
		} else {
			return {
				ctor: '::',
				_0: _toastal$either$Either$Right(
					{
						ctor: '::',
						_0: _p3._0,
						_1: _toastal$either$Either$rights(ys)
					}),
				_1: _user$project$Bpm$groupEither(zs)
			};
		}
...
var _user$project$Bpm$toEither = function ($char) {
	return _elm_lang$core$Char$isDigit($char) ? _toastal$either$Either$Right($char) : _toastal$either$Either$Left($char);
};
var _user$project$Bpm$fromString = function (_p5) {
	return A2(
		_elm_lang$core$List$map,
		function (_p6) {
			return A2(
				_toastal$either$Either$map,
				_user$project$Bpm$strToFloat,
				A2(_toastal$either$Either$mapEach, _elm_lang$core$String$fromList, _p6));
		},
		_user$project$Bpm$groupEither(
			A2(
				_elm_lang$core$List$map,
				_user$project$Bpm$toEither,
				_elm_lang$core$String$toList(_p5))));
};
var _user$project$Bpm$toFloats = function (_p7) {
	return _toastal$either$Either$rights(
		_user$project$Bpm$fromString(_p7));
};
var _user$project$Bpm$map = function (f) {
	return _elm_lang$core$List$map(
		_toastal$either$Either$map(f));
};
var _user$project$Bpm$toString = function (_p8) {
...
var _user$project$Bpm$mapString = function (f) {
	return function (_p10) {
		return _user$project$Bpm$toString(
			A2(
				_user$project$Bpm$map,
				f,
				_user$project$Bpm$fromString(_p10)));
	};
};

var _user$project$Layout$model = {primary: _debois$elm_mdl$Material_Color$Indigo, accent: _debois$elm_mdl$Material_Color$Red};
var _user$project$Layout$Model = F2(
	function (a, b) {
...
var _user$project$Models$Song = F4(
	function (a, b, c, d) {
...
var _user$project$Msgs$OnFetchAllSongs = function (a) {
	return {ctor: 'OnFetchAllSongs', _0: a};
};

var _user$project$Cmds$encodeSong = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'folder',
				_1: _elm_lang$core$Json_Encode$string(record.folder)
			},
			_1: {
				ctor: '::',
				_0: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'bpm',
						_1: _elm_lang$core$Json_Encode$string(record.bpm)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'notes',
							_1: _elm_lang$core$Json_Encode$string(record.notes)
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Cmds$decodeSong = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'folder',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$Song)))));
var _user$project$Cmds$encodeSongsByFoot = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'foot',
				_1: _elm_lang$core$Json_Encode$int(record.foot)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Cmds$encodeSong, record.songs))
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Cmds$decodeSongsByFoot = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'songs',
	_elm_lang$core$Json_Decode$list(_user$project$Cmds$decodeSong),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'foot',
		_elm_lang$core$Json_Decode$int,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$SongsByFoot)));
var _user$project$Cmds$encodeAllSongs = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_0: 'songsByfoot',
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _user$project$Cmds$encodeSongsByFoot, record.songsByfoot))
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Cmds$decodeAllSongs = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'songsByfoot',
...
var _user$project$Cmds$fetchAllSongs = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Msgs$OnFetchAllSongs,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Cmds$jsonPath, _user$project$Cmds$decodeAllSongs)));

var _user$project$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'OnFetchAllSongs':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Util$hss = A2(
	...
	A2(
		...
		A2(_elm_lang$core$List$range, 1, 16)),
	A2(
		_elm_lang$core$List$map,
		function (_p1) {
			return A2(
		...
		A2(_elm_lang$core$List$range, 9, 16)));
var _user$project$Util$calcHs = F2(
	function (speed, bpm) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			_elm_lang$core$List$head(
				A2(
					...
					function (hs) {
						return _elm_lang$core$Basics$abs((bpm * hs) - speed);
					},
			...
			_user$project$View$cardStyle,
			{
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_user$project$View$songRow(model),
							songsByFoot.songs)),
					_1: {ctor: '[]'}
				}
			});
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src('resources/title.svg'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Layout$href('https://github.com/matonix/drasphid'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src('resources/mark-github.svg'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
		...
		return A3(
			...
			A4(
				...
				},
				{
					...
					tabs: {
						ctor: '_Tuple2',
						_0: _user$project$View$tabTitles(allSongs),
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Color$background(
								A2(_debois$elm_mdl$Material_Color$color, model.layout.primary, _debois$elm_mdl$Material_Color$S400)),
					...
					main: {
						ctor: '::',
						_0: A2(_user$project$View$mainArea, model, allSongs),
						_1: {ctor: '[]'}
					}
				}));
	});
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$response(model),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Models$initModel, _1: _user$project$Cmds$fetchAllSongs};
