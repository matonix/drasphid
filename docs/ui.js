...
var _user$project$Models$initModel = {allSongs: _krisajenkins$remotedata$RemoteData$Loading};
...
var _user$project$View$maybeSongs = function (response) {
	var _p0 = response;
	switch (_p0.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return _user$project$View$viewAllSongs(_p0._0);
		default:
			return _elm_lang$html$Html$text(
...
var _user$project$View$page = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$maybeSongs(model.allSongs),
				_1: {ctor: '[]'}
			}
		});
};
